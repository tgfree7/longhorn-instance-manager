...
_INTERFACE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='interface', full_name='Interface.interface', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATAIP = _descriptor.Descriptor(
  name='DataIP',
  full_name='DataIP',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='dataIP', full_name='DataIP.dataIP', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['DataIP'] = _DATAIP
...
DataIP = _reflection.GeneratedProtocolMessageType('DataIP', (_message.Message,), {
  'DESCRIPTOR' : _DATAIP,
  '__module__' : 'rpc_pb2'
  # @@protoc_insertion_point(class_scope:DataIP)
  })
_sym_db.RegisterMessage(DataIP)
...
_PROCESSMANAGERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetInterfaceIP',
    full_name='ProcessManagerService.GetInterfaceIP',
    index=7,
    containing_service=None,
